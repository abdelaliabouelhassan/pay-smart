  ...
  <section class="w-full flex bg-white py-24">
    <div class="m-auto w-full max-w-[1059px] relative">
      <div class="w-full grid grid-cols-2 gap-10">
        <div class="col-span-2 w-full bg-[#F5F6F7] rounded-3xl overflow-hidden">
          <div class="w-full flex justify-between items-center">
            <div class="pl-6 py-2 w-full max-w-[532px] space-y-5">
              ...
              >
              <p class="text-[#616C7C] text-lg font-medium font-Inter">
        ...
        <div class="col-span-1 w-full bg-[#F5F6F7] rounded-3xl overflow-hidden">
          <div class="w-full">
            <div class="pl-6 pt-10 w-full max-w-[532px] space-y-5">
              <span class="font-Inter font-semibold text-[#1B2C42] text-5xl"
                >Buy and Sell</span
              >
              <p class="text-[#616C7C] text-lg font-medium font-Inter  max-w-[440px]">
        ...
        >
          ...
          <div class="w-full px-2 absolute bottom-2">
            <div class="w-full bg-[#1B2C42CC] p-5 rounded-3xl">
