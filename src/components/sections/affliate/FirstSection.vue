<template>
 <section
    class="
      ...
      font-Inter
      dark:bg-[#1C1C1C]
      md:pt-24 pt-24 sm:h-[100vh] h-[100vh] relative overflow-hidden 
    "
  >
    <div
    ...
    >
      <div class="w-full max-w-[1150px] m-auto md:pt-28 pt-5 pb-10 md:px-5 z-50">
        <div class="w-full grid grid-cols-1 md:grid-cols-2 md:gap-10 z-50">
           <div class="flex flex-col items-start px-4 md:px-0 space-y-4 md:space-y-8 w-full z-50  md:pb-10">
           ...
           <div class="w-full h-[376px] md:h-[542px] max-w-[677.6px]  z-10">
            <img
              src="../../../assets/users.png"
              class="w-full md:h-[676px] absolute max-w-[677.6px]  lg:right-20  bottom-0 md:block hidden "
              alt=""
            />
            <img
              src="../../../assets/users111.png"
              class="w-full max-w-[500px] sm:max-w-max  sm:max-h-[477.6px] absolute   bottom-0 md:hidden block z-50 "
              alt=""
            />
           </div>
  ...
  <!-- <section class="w-full md:h-[100vh]  flex bg-[#F5F6F7] font-Inter dark:bg-[#1C1C1C] pt-36 overflow-hidden">
    <div class="w-full relative md:h-[100vh] ">
      <div class=" w-full md:absolute md:bottom-[9rem]">
        <div class="w-full h-full max-w-[1170px] flex md:flex-row flex-col space-y-8 tall:space-y-[40rem] tallMax:space-y-[60rem] tallmin:space-y-[20rem]  items-start m-auto md:space-y-[15rem] md:pl-2">
       ...
       <img
        ...
        <img
          src="../../../assets/hoverheroeffectdark.png"
          class="w-full h-full absolute object-none md:object-cover bottom-[24px] md:bottom-auto    dark:block md:hidden"
          alt=""
        />
    </div>
  </section> -->
